package cl.falabella.publicsite.automation.definition.steps;
...
import cl.falabella.publicsite.automation.constants.Constants;
	...
	public void ingresar_producto(String producto) throws Throwable {
	  try {
        ...
        for (int x = 0; x < div.size(); x++) {
          if (div.get(x).getText().equals(producto)) {
