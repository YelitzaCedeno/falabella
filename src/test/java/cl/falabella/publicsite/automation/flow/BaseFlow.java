...
import cl.falabella.publicsite.automation.constants.ReportUtils;
import cl.falabella.publicsite.automation.model.PageModel;
import cl.falabella.publicsite.automation.util.GenericMethods;
import cl.falabella.publicsite.automation.util.PSCException;
import cl.falabella.publicsite.automation.util.ValidarCompraArticulo;
...
public class BaseFlow {
    ...
    public static void beforeClass() {
        try {
            driver = ValidarCompraArticulo.setup();
    ...
    private static String CrearCaptura(WebDriver driver) {
        ...
        try {
            FileUtils.copyFile(Captura,
                    new File(ValidarCompraArticulo.curDir + "//report" + "//evidencias" + "//" + uuid + ".png"));
        } catch (Exception e) {
