...
public class ValidarCompraArticulo {
	...
	public static WebDriver setup() throws MalformedURLException {
		...
		if (browser.equalsIgnoreCase("mozilla")) {
			...
			System.setProperty("webdriver.gecko.driver", curDir  +"\\WebDriver\\Firefox\\Windows\\64\\geckodriver.exe");
		...
		if (browser.equalsIgnoreCase("ie")) {
		 ...
		 if (browser.equalsIgnoreCase("zalenium")) {
				...
				System.setProperty("webdriver.chrome.driver", curDir + "\\WebDriver\\Chrome\\Windows\\chromedriver701.exe");
				cap.setCapability(ChromeOptions.CAPABILITY, options);
				driver = new RemoteWebDriver( new URL("http://172.18.4.120:4444/wd/hub"), cap);
			 }
		 return driver;
	}
